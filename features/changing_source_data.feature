Feature: See up-to-date metadata for GIS datasets in Ichabod
  ...
  Scenario: Update data and check for new value of Publisher field
    Given I change the "Spatial Data Repository" source data in the "publisher" field to "New York City Dept of City Planning" for the record identified by "DSS.NYCDCP_Admin_Bndry_10cav\DSS.nyfb_05R"
