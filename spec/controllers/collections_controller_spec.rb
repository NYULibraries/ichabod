  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved collection as @collection" do
        ...
        post :create, {:collection => { "identifier" => "invalid value" }}, valid_session
        assigns(:collection).should be_a_new(Collection)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested collection" do
        ...
        Collection.any_instance.should_receive(:update).with({ "identifier" => "MyString" })
        put :update, {:id => collection.to_param, :collection => { "identifier" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the collection as @collection" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Collection.any_instance.stub(:save).and_return(false)
        put :update, {:id => collection.to_param, :collection => { "identifier" => "invalid value" }}, valid_session
        assigns(:collection).should eq(collection)
      end
