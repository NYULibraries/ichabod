...
if not exist "%FEDORA_HOME%\client\fcrepo-client-admin-3.6.1.jar" goto clientNotFound
...
echo Client cannot be found at %FEDORA_HOME%\client\fcrepo-client-admin-3.6.1.jar
goto end
